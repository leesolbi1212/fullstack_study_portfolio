...
export async function createUser(
  ...
  const [result] = await db.query(
    "insert into member (userid, userpw, name, hp, email, gender, ssn1, ssn2, zipcode, address1,address2,address3) value (?,?,?,?,?,?,?,?,?,?,?,?)",
    [
      userid,
      userpw,
      name,
